...
@Component({
  selector: 'app-registro-biblio',
  templateUrl: './registro-biblio.component.html',
  styleUrls: ['./registro-biblio.component.scss']
})
export class RegistroBiblioComponent implements OnInit{

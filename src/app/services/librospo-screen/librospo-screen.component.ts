...
@Component({
  selector: 'app-librospo-screen',
  templateUrl: './librospo-screen.component.html',
  styleUrls: ['./librospo-screen.component.scss']
})
export class LibrospoScreenComponent implements OnInit {
  ...
  //Para la tabla
  displayedColumns: string[] = ['id', 'titulo', 'id_autor', 'id_genero', 'veces_prestado'];
  ...
  public initPaginator(){
   ...
   public obtenerLibros(){
    this.librosService.obtenerListaLibrosPopulares().subscribe(
      (response)=>{

...
@Component({
  selector: 'app-clientesact-screen',
  templateUrl: './clientesact-screen.component.html',
  styleUrls: ['./clientesact-screen.component.scss']
})
export class ClientesactScreenComponent implements OnInit {
  ...
  //Para la tabla
  displayedColumns: string[] = ['nombre', 'prestamos_solicitados'];
  ...
  public obtenerClientes(){
    this.clientesService.obtenerListaClientesMasActivos().subscribe(
      (response)=>{

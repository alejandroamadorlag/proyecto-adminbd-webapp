...
@Component({
  selector: 'app-librosnodisponibles-screen',
  templateUrl: './librosnodisponibles-screen.component.html',
  styleUrls: ['./librosnodisponibles-screen.component.scss']
})
export class LibrosnodisponiblesScreenComponent implements OnInit {
  ...
  //Para la tabla
  displayedColumns: string[] = ['id', 'titulo', 'id_autor', 'id_genero', 'fecha_registro', 'editar', 'eliminar'];
  ...
  public initPaginator(){
   ...
   public obtenerLibros(){
    this.librosService.obtenerListaLibrosNoDisponibles().subscribe(
      (response)=>{
